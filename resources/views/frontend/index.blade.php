            ...
            <div class="row mt-n2 wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-12 text-center">
                    <ul class="list-inline mb-5" id="portfolio-flters">
                        <li class="mx-2 " data-filter="*"><a href="{{route('service')}}" style="text-decoration: none; color: black"> Tất cả </>
                        </li>
                        <li class="mx-2" data-filter=".first"><a href="{{route('service')}}" style="text-decoration: none; color: black">Tìm kiếm sân bóng</>
                        </li>
                    ...
                    <div class="service-item rounded overflow-hidden">
                        <div class="service-item-img">
                            <a href="{{ route('detail-pitches',$item->id)}}" class="img-link">
                                <img src="{{ asset($item->images)}}" alt="" style="object-fit: contain">
                            </a>
                        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row mt-n2 wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-12 text-center">
                    <ul class="list-inline mb-5" id="portfolio-flters">
                        <li class="mx-2 active" data-filter="*"><a href="{{route('product')}}" style="text-decoration: none; color: black">Tất cả</>
                        </li>
                        <li class="mx-2" data-filter=".first"><a href="{{route('product')}}" style="text-decoration: none; color: black">Tìm kiếm sản phẩm</>
                        </li>
                        <li class="mx-2" data-filter=".second">Quần áo bóng đá</li>
                        <li class="mx-2" data-filter=".third">Các dụng cụ liên quan</li>
                    </ul>
            ...
            <div class="row mt-n2 wow fadeInUp" data-wow-delay="0.5s">
